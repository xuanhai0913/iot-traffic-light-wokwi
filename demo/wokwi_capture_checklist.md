...
|---:|---|---|---|
| 1 | Start simulation in AUTO | LCD shows AUTO, one direction green and conflicting direction red | `assets/wokwi/wokwi_auto.png` |
| 2 | Press NIGHT or send `n` | Yellow warning blink / LCD NIGHT | `assets/wokwi/wokwi_night.png` |
| 3 | Send `p` or `priority_ns` | North/South green, East/West red | `assets/wokwi/wokwi_priority_ns.png` |
| 4 | Send `pe` or `priority_ew` | East/West green, North/South red | `assets/wokwi/wokwi_priority_ew.png` |
| 5 | Press EMERGENCY or send `e` | All directions red / LCD EMERGENCY | `assets/wokwi/wokwi_emergency.png` |
...
| Evidence | Status |
|---|---|
| `assets/wokwi/wokwi_compile_run.png` | Saved |
| `assets/wokwi/wokwi_auto.png` | Saved |
| `assets/wokwi/wokwi_night.png` | Saved |
| `assets/wokwi/wokwi_priority_ns.png` | Saved |
| `assets/wokwi/wokwi_priority_ew.png` | Saved |
| `assets/wokwi/wokwi_emergency.png` | Saved |
...
```text
Trong ban nang cap, Flutter/PWA gui REST command den C# API.
