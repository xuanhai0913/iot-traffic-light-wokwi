...
## 9. Evidence da co ngay 15/06/2026
...
- Anh da luu trong `assets/wokwi/`: `wokwi_compile_run.png`, `wokwi_auto.png`, `wokwi_night.png`, `wokwi_priority_ns.png`, `wokwi_priority_ew.png`, `wokwi_emergency.png`.
