...
Đề bài ghi có thể điều khiển bằng app mobile hoặc WinForm. Kế hoạch ban đầu từng ưu tiên làm Wokwi trước để tránh loãng scope. Ở trạng thái repository hiện tại, dự án đã vượt mức đó: ngoài Wokwi còn có backend C#, SQLite, MQTT bridge và Flutter app/web.
...
- Flutter web và Flutter app để thể hiện lớp app điều khiển.
...
- Có Flutter app hoặc Flutter web để đáp ứng ý "điều khiển bằng app mobile/WinForm".
