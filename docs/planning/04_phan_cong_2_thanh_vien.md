...
|---|---|---|
| Nguyễn Xuân Hải | Nhóm trưởng, chốt scope, thiết kế hệ thống, Wokwi, code điều khiển, backend C#, Flutter app/web, kiểm thử, demo, tích hợp bản nộp | Phần implementation và tích hợp chính của dự án |
...
- Thực hiện Flutter app/web, script verify/build/demo và các tài liệu kỹ thuật chính.
...
- Flutter app `flutter_app/` cho mobile và web.
...
- Hỗ trợ phần database/ERD theo hướng yêu cầu trong `docs/design/08_requirements.md`.
...
|---|---|
| Nguyễn Xuân Hải | Thực hiện phần chính của dự án: scope, kiến trúc hệ thống, Wokwi, code điều khiển, backend C#, Flutter app/web, kiểm thử, demo và tích hợp bản nộp cuối |
