...
| Chốt scope MVP | Nguyễn Xuân Hải | [x] | Đã chốt tại `docs/planning/10_week1_hai_deliverables.md` |
...
| Task | Owner | Trạng thái | Ghi chú |
|---|---|---:|---|
| Vẽ sơ đồ khối | Nguyễn Xuân Hải | [x] | Đã có trong `docs/design/09_so_do_thiet_ke.md` |
...
| Chốt requirements CSDL/OOP/dashboard | Nguyễn Xuân Hải | [x] | Đã tạo `docs/design/08_requirements.md` |
| Thiết kế ERD/database schema | Trần Đình Đức | [~] | Có hỗ trợ một phần theo `docs/design/08_requirements.md`; cần ghi đúng phạm vi đóng góp |
...
| Task | Owner | Trạng thái | Ghi chú |
|---|---|---:|---|
| Thiết kế giao diện điều khiển app/web | Nguyễn Xuân Hải | [x] | Đã có `flutter_app/` gọi backend thật |
| Tạo màn hình AUTO/NIGHT/PRIORITY/EMERGENCY | Nguyễn Xuân Hải | [x] | Flutter app đã gọi API thật |
| Viết phần giải thích mở rộng app | Nguyễn Xuân Hải | [x] | Đã có `docs/design/12_mobile_app_extension.md` |
| Chốt dashboard/app đưa vào slide | Nguyễn Xuân Hải | [~] | Cần chụp ảnh app đưa vào slide/report |
