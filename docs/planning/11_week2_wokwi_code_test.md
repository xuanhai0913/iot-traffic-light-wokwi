...
- [ ] Chụp 5 ảnh: `docs/evidence/wokwi/wokwi_auto.png`, `docs/evidence/wokwi/wokwi_night.png`, `docs/evidence/wokwi/wokwi_priority_ns.png`, `docs/evidence/wokwi/wokwi_priority_ew.png`, `docs/evidence/wokwi/wokwi_emergency.png`.
