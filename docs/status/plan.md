...
- Da luu anh evidence vao `docs/evidence/wokwi/wokwi_auto.png`, `wokwi_night.png`, `wokwi_priority_ns.png`, `wokwi_priority_ew.png`, `wokwi_emergency.png`, va `wokwi_compile_run.png`.
